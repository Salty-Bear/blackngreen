...
import { GoogleAuthProvider, GithubAuthProvider, idToken, user, OAuthProvider } from '@angular/fire/auth';
...
/* ############################################################
  Creating Sign in with Microsoft service for logging in
 ############################################################ */

//   microsoftSignIn() {
//   return this.fireAuth.signInWithPopup(this.microsoft ).then(
//     res => {
//       this.router.navigate(['/dashboard'])
//       localStorage.setItem('token',JSON.stringify(res.user?.uid))
//     },
